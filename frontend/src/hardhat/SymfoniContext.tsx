...
import { BasicContract } from "./tcmodels/BasicContract";
import { BasicContract__factory } from "./tcmodels/factories/BasicContract__factory";
...
export const BasicContractContext = React.createContext<SymfoniBasicContract>(emptyContract);
...
export interface SymfoniBasicContract {
    instance?: BasicContract;
    factory?: BasicContract__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [BasicContract, setBasicContract] = useState<SymfoniBasicContract>(emptyContract);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setBasicContract(getBasicContract(_provider, _signer))
                finish(text)
            }
    ...
    const getBasicContract = (_provider: providers.Provider, _signer?: Signer) => {

        const contractAddress = "0xf21feB4f8f6Be5C523F2E0A5FB2a326241571539"
        const instance = _signer ? BasicContract__factory.connect(contractAddress, _signer) : BasicContract__factory.connect(contractAddress, _provider)
        const contract: SymfoniBasicContract = {
            instance: instance,
            factory: _signer ? new BasicContract__factory(_signer) : undefined,
        }
        return contract
    }
        ;
            ...
            <ProviderContext.Provider value={[provider, setProvider]}>
                <SignerContext.Provider value={[signer, setSigner]}>
                    <CurrentAddressContext.Provider value={[currentAddress, setCurrentAddress]}>
                        <BasicContractContext.Provider value={BasicContract}>
                            {showLoading && loading ?
